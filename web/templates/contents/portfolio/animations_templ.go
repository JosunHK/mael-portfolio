...
func AnimationsShowcase(animations []sqlc.Animation) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<div id=\"animation-slide-container\" class=\"h-[90dvh] relative max-md:mb-4 min-h-[400px]\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		for i, animation := range animations {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "\" class=\"w-[82dvw] md:w-[92dvw] h-full bg-zinc-300/45 backdrop-blur-lg translate-z-0 border-2 border-black/20 z-20 relative rounded-xl p-2 font-barlow text-gray-700 snap-center md:block flex flex-col items-center\"><div class=\"px-8 mt-2 mb-4 h-min flex flex-row justify-between w-full\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = card.Card(card.Props{
				Class: `md:ml-8 flex justify-center items-center h-[80dvh] w-[77dvw] bg-black/5 p-4 border-black/80 py-2 flex-col justify-start items-start`,
