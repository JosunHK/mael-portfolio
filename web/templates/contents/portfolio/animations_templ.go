...
import (
	...
	"mael/web/templates/components/animation/animationDesignFront"
...
func AnimationsShowcase(animations []sqlc.Animation) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for i, animation := range animations {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "</div><div class=\"flex justify-center items-center h-full w-full gap-4 mt-8 md:h-full md:mt-0 z-30 relative [@media(max-height:700px)]:items-start\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, " <div x-data=\"animationSliderInsert\" x-init=\"insertVerMain\" ver-id=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "\" class=\"absolute\"></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				for _, subAnimation := range animationUtil.GetSubAnimations(ctx, animation.ID) {
					templ_7745c5c3_Err = animationComponent.SubAnimationReelSlider(subAnimation, animationUtil.GetSubAnimationPaths(subAnimation.ID), i, animation).Render(ctx, templ_7745c5c3_Buffer)
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, " <div class=\"absolute\" x-data=\"animationSliderInsert\" x-init=\"insertVerSub\" ver-id=\"")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
		...
		templ_7745c5c3_Err = FrontDesign.AnimationFrontDesign().Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func AnimationShowcaseButtons(animationCount int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "<div class=\"h-full w-screen absolute bottom-6 md:bottom-0 flex flex-row justify-between items-end md:items-center left-0  px-4 \">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
