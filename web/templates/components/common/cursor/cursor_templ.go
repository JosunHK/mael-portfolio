...
func Cursor() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div id=\"custom-cursor\" class=\"cursors rotate-[55deg] origin-left w-min fixed opacity-0 pointer-events-none\"><div id=\"cursor-stroke-horizontal\" class=\"bg-black w-[22px] h-[2px] transition-transform duration-300\"></div><div id=\"cursor-stroke-vertical\" class=\"bg-black w-[20px] h-[2px]  transition-transform duration-300 cursor-stroke-vertical-transform origin-left\"></div></div><div class=\"cursors custom-cursor-trail rotate-[55deg] origin-left w-min fixed left-[-100px] top-[-100px] pointer-events-none opacity-0\"><div class=\"bg-black bg-opacity-20 w-[22px] h-[2px] transition-transform duration-300 ease-in-out\"></div><div class=\"bg-black bg-opacity-20 w-[20px] h-[2px] transition-transform duration-300 ease-in-out cursor-stroke-vertical-transform origin-left\"></div></div>")
		if templ_7745c5c3_Err != nil {
